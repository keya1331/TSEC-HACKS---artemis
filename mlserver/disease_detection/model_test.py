...
model = tf.keras.models.load_model(r'E:\Programs\TSEC\TSEC-HACKS---artemis\mlserver\disease_detection\model\model.h5')

# Get a list of files in the test folder
files = os.listdir(r"E:\Programs\TSEC\TSEC-HACKS---artemis\mlserver\disease_detection\src\Test")
...
file_path = os.path.join(r"E:\Programs\TSEC\TSEC-HACKS---artemis\mlserver\disease_detection\src\Test", files[int(test) - 1])
