...
model = __import__("tensorflow").keras.models.load_model(
    r"E:\Programs\TSEC\TSEC-HACKS---artemis\mlserver\wildfire_detection\models\meteorological-detection-classification.keras"
)

std_scaler = joblib.load(r"E:\Programs\TSEC\TSEC-HACKS---artemis\mlserver\wildfire_detection\models\std_scaler_weather.pkl")
