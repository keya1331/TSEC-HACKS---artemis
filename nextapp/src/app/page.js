        ...
        >
          ...
          <div className="relative z-20 flex flex-col justify-center items-center h-full px-8 text-center text-white">
            ...
            <button
              ...
              className="px-6 py-3 bg-[#BAD799] text-[#081707] font-semibold rounded-md hover:bg-[#237414] transition duration-300"
            >
        ...
        <section className="bg-[#237414] text-[#BAD799] py-16">
          <div className="text-center max-w-6xl mx-auto px-6">
            ...
            <p className="text-lg mb-6">
              Your input plays a critical role in protecting wildlife and
              preserving their habitats. If you encounter any unusual
              activities, environmental hazards, or threats to wildlife, let us
              know anonymously. Every report helps us monitor, address, and
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-[#BAD799] text-[#084C20] rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-base">
                  Submit wildlife threats with ease. No personal details are
                  required, ensuring your anonymity.
                </p>
              </div>
              {/* Feature 2 */}
              <div className="bg-[#BAD799] text-[#084C20] rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-base">
                  Enable location services to include precise coordinates,
                  allowing us to act quickly and accurately.
                </p>
              </div>
              {/* Feature 3 */}
              <div className="bg-[#BAD799] text-[#084C20] rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-base">
                  Attach images or videos of the threats to provide additional
                  evidence and context for our response team.
                </p>
              </div>
              {/* Feature 4 */}
              <div className="bg-[#BAD799] text-[#084C20] rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-base">
                  Your reports directly feed into our monitoring systems,
                  ensuring rapid identification of high-risk areas.
                </p>
              </div>
            </div>

            <p className="text-sm text-[#BAD799] mt-8 italic">
              All reports are processed confidentially. Together, we can make a
              significant impact in conserving wildlife.
            </p>
        ...
        <section className="bg-[#BAD799] text-[#081707] py-16">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg">
                Connect with wildlife enthusiasts and conservationists from
                around the globe. Explore, learn, and contribute to a better
                future for wildlife.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-b from-[#237414] to-[#6DBE47] opacity-20 rounded-lg group-hover:opacity-40 transition-opacity duration-300"></div>
                <div className="relative z-10 p-6 text-center">
                  <h3 className="text-2xl font-bold mb-4">Photo Gallery</h3>
                  <p className="text-sm mb-6">
                    Immerse yourself in stunning wildlife imagery shared by
                    community members.
                  </p>
                  <button
                    onClick={() => (window.location.href = "/community")}
              ...
              {/* Wildlife Guides */}
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-b from-[#BAD799] to-[#84C16B] opacity-20 rounded-lg group-hover:opacity-40 transition-opacity duration-300"></div>
                <div className="relative z-10 p-6 text-center">
                  <h3 className="text-2xl font-bold mb-4">Wildlife Guides</h3>
                  <p className="text-sm mb-6">
                    Access comprehensive guides on wildlife species and
              ...
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-b from-[#6DBE47] to-[#237414] opacity-20 rounded-lg group-hover:opacity-40 transition-opacity duration-300"></div>
                <div className="relative z-10 p-6 text-center">
                  ...
                  <p className="text-sm mb-6">
                    ...
                    like-minded individuals passionate about wildlife
                    conservation.
                  </p>
                  <button
                    onClick={() => (window.location.href = "/community")}
            ...
            <div className="text-center mt-12">
              <p className="text-sm italic text-[#084C20]">
                Together, we can create a safe haven for wildlife. Be a part of
                the change.
              </p>
            </div>
          </div>
        ...
        <section className="bg-[#237414] text-[#BAD799] py-16">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <div className="mb-12">
              ...
              <p className="text-lg">
                Discover innovative tools to track wildlife, detect threats, and
                protect biodiversity with cutting-edge technology.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex flex-col items-center md:flex-row md:justify-between md:space-x-12 py-16">
                <div className="md:w-1/2 px-6 order-2 md:order-1">
                  ...
                  <p className="text-lg mb-6">
                    Use advanced detection tools to identify plant species and
                    track animal populations. Help map biodiversity hotspots and
                    protect habitats effectively.
                  </p>
                  <button
                    onClick={() =>
                      (window.location.href = "/features/florafauna/form")
                    }
              ...
              <div className="relative flex flex-col items-center md:flex-row md:justify-between md:space-x-12 py-16">
                ...
                <div className="md:w-1/2 px-6">
                  <h3 className="text-3xl font-bold mb-4">
                    Wildfire Camera Detection
                  </h3>
                  <p className="text-lg mb-6">
                    Leverage cutting-edge camera systems to monitor and detect
                    wildfires in real-time. Protect ecosystems from the
                    devastating impacts of wildfires.
                  </p>
                  <button
                    onClick={() =>
                      (window.location.href = "/features/wildfire/camera")
                    }
                    className="px-6 py-3 bg-[#6DBE47] text-white font-semibold rounded-md hover:bg-[#1D5D0F] transition duration-300"
                  >
            ...
            <div className="mt-12">
              <p className="text-sm italic">
                These features are designed to empower individuals and
                organizations to safeguard biodiversity and wildlife. Join us in
                this mission today!
              </p>
            </div>
          </div>
        ...
        <section className="bg-gradient-to-br from-[#BAD799] to-[#8AAC8B] text-[#081707] py-16">
          <div className="text-center max-w-5xl mx-auto px-6">
            ...
            <p className="text-lg mb-8">
              We are a passionate team of conservationists, technologists, and
              nature enthusiasts dedicated to protecting wildlife and preserving
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
              <div className="rounded-lg shadow-lg p-6 bg-gradient-to-br from-[#6DBE47] to-[#84C16B]">
                <h3 className="text-2xl font-bold text-[#081707] mb-4">
                  Our Mission
                </h3>
                <p>
                  To build a world where humans and wildlife coexist
                  harmoniously by fostering awareness, implementing innovative
                  tools, and enabling global conservation efforts.
                </p>
              </div>
              <div className="rounded-lg shadow-lg p-6 bg-gradient-to-br from-[#84C16B] to-[#BAD799]">
                ...
                <p>
                  Combining cutting-edge technology, community engagement, and
                  research-driven solutions to tackle the challenges of habitat
                  loss, climate change, and wildlife protection.
                </p>
              </div>
              <div className="rounded-lg shadow-lg p-6 bg-gradient-to-br from-[#8AAC8B] to-[#6DBE47]">
                ...
                <p>
                  With every project, we aim to restore ecosystems, protect
                  endangered species, and inspire a global movement for
            ...
            <div className="mt-12">
              <p className="text-lg mb-6">
                Join us on this journey to create a greener, safer planet for
                all living beings.
              </p>
              <button onClick={() => (window.location.href = "/aboutus")} className="px-8 py-4 bg-[#237414] text-[#BAD799] font-bold rounded-lg hover:bg-[#1D5D0F] transition duration-300">
                Get to Know Us
              </button>
            </div>
          </div>
